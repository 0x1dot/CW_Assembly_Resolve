...
namespace Test
{
    ...
    internal static class AssemblyLoader
    {
        ...
        {
            //AssemblyLoader.assemblyNames.Add("ihtiyaç duyulan referans kütüphanenin adı".ToLowerInvariant(), "Gömülü bellekteki konumu");//klasör bilgisini dahil edin varsa..
            AssemblyLoader.assemblyNames.Add("TestLibrary".ToLowerInvariant(), "Test.kutuphane.0xCompressed");
        }
